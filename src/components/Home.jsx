    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6">
      <div className="text-center">
        <motion.h1 
         ...
         initial="hidden"
         animate="visible"
         className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold mt-2 bg-gradient-to-r from-blue-400 via-purple-500 to-indigo-600 bg-clip-text text-transparent">
        ...
        <div className="flex justify-center gap-4">
          <Link to="/bot">
            <button className="group relative">
              <div className="text-xl relative z-10 inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-20 font-medium text-black transition-all duration-300 group-hover:-translate-x-3 group-hover:-translate-y-3 group-hover:text-blue-700 group-active:translate-x-0 group-active:translate-y-0">
                Start Conversation
              </div>
